    ...
    try:
        ...
        for post_div in post_divs:
            try:
                ...
                print(f"  Warning: Failed to parse post in {html_path}: {e}")
                continue
...
def process_all_html_files(base_dir='saved_html', output_base_dir='saved_json'):
    ...
    for html_file in html_files:
        ...
        json_file = Path(output_base_dir) / relative_path.with_suffix('.json')
        ...
        if posts:
            ...
            print(f"  ⚠ No posts found in this file")
...
def main():
    """Main entry point."""
    print("=" * 60)
    print("HTML to JSON Parser for LobbyX Job Postings")
    print("=" * 60)
